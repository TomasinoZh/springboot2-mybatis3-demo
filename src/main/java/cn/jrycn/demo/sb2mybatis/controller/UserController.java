...
public class UserController {
  ...
  @ApiOperation("查询单个用户")
  public Object findUser(@RequestParam(name = "account", required = true) String account) {
    return userService.findUser(account);
  }

  @RequestMapping(value = "/remove/{id}", method = RequestMethod.DELETE)
  @ApiOperation("删除用户")
  public int removeUser(@Valid @PathVariable(name = "id", required = true) Integer id) {

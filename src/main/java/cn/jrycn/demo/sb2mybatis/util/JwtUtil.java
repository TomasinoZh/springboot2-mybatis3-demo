...
public class JwtUtil {
   ...
   * @throws Exception
   */
  public String createJwt(String id, String issuer, String appid, String uid, String subject,
  ...
  public static void main(String[] args) {
    String subject = "{\"officeId\":1}";

    try {
      JwtUtil util = new JwtUtil();
      String jwt =
          util.createJwt(JwtUtil.JWT_ID, "jrycn", "appid", "userid", subject, JwtUtil.JWT_TTL);
